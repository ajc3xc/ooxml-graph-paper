...
\node[lbl, align=left, text width=4.2cm, gray] (note) at (6.0, 8.8) {not exercised in this\\benchmark -- target is\\pre-resolved at\\corpus-build time};
\draw[gray, -{Latex[length=1.6mm]}] (note.west) -- (discover.east);
\end{tikzpicture}
\caption{Meridian Docs' overall functional architecture, including the discovery step a real
deployment needs and this benchmark's harness bypasses (Section~\ref{sec:methods}). Editing
